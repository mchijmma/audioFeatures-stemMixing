...
#path = './Music/Data/MedleyDB/Features/Arrays_original_1812_no_boot/%s/' % (kType)
#%%
...
#d_bass = loadPickle('d_bass.pkl')
#d_bass2 = loadPickle('d_bass2.pkl')
#d_bass3 = loadPickle('d_bass3.pkl')
#d_bass4 = loadPickle('d_bass4.pkl')
#d_keys = loadPickle('d_keys.pkl')
#d_keys2 = loadPickle('d_keys2.pkl')
#d_keys3 = loadPickle('d_keys3.pkl')
#d_keys4 = loadPickle('d_keys4.pkl')
#d_vocal = loadPickle('d_vocal.pkl')
#d_vocal2 = loadPickle('d_vocal2.pkl')
#d_vocal3 = loadPickle('d_vocal3.pkl')
#d_vocal4 = loadPickle('d_vocal4.pkl')
#d_guitar = loadPickle('d_guitar.pkl')
#d_guitar2 = loadPickle('d_guitar2.pkl')
#d_guitar3 = loadPickle('d_guitar3.pkl')
#d_guitar4 = loadPickle('d_guitar4.pkl')
#dfBass = loadPickle('dfbass.pkl')
#dfKeys = loadPickle('dfkeys.pkl')
#dfVocal = loadPickle('dfvocal.pkl')
#dfguitar = loadPickle('dfguitar.pkl')
...
def removeFeatures(data, label, features, itera = 0, epoch = 10, nEstimators = 128, _type = 'Boot'):
...
def removeFeatures3(data, label, nEstimators = 100, _type = 'Boot'):
  ...
  oob_error_ntrees, n = getNumberTrees(data, label, min_estimators = 50,
                                  max_estimators = 200, epoch = 100)                                   
  print '# trees: %d' % n 
  dict1 = removeFeatures(data, label, gReducedFeatures[kGroup],
                                 itera = kFeatures-101, epoch = 2, nEstimators = n, _type = _type)  
  print 'dict2'
  dict2 = removeFeatures(dict1['X'], label, dict1['Reduced'],
                             itera = 0, epoch = 100, nEstimators = n, _type = _type)  
  ...
  dict3 = removeFeatures(data2, label, dfeatures,
                                  itera = 0, epoch = 200, nEstimators = n, _type = _type)    
  ...
  dict4 = removeFeatures(data3, label, dfeatures,
                                  itera = 0, epoch = 2000, nEstimators = n, _type = _type)
...
def removeFeatures4Permutation(data, label, nEstimators = 100):
  ...
  dict3 = removeFeaturesPermutation(data2, label, dfeatures,
                                  itera = 0, epoch = 200, nEstimators = n)    
  ...
  dict4 = removeFeaturesPermutation(data3, label, dfeatures,
                                  itera = 0, epoch = 2000, nEstimators = n)
...
#                                      oob_score=True, max_features='sqrt', random_state=None)
      ...
      for j in range(_epoch):
          ...
          feature_importances =  oobC.featureImportances(forest, _A, label, 10)
...
#
#oob_error_ntrees = getNumberTrees(X[kGroup], y[kGroup], min_estimators = 10,
#                                  max_estimators = 1000, epoch = 10)    
##%%
## Estimate mean OOB error and mean feature importance after N epochs
#                                  
#RFmeanOOBerror(A, y[kGroup],
#                 gNameFeatures[kGroup], epoch = 100, nEstimators = 128,
#                               nFeatures = 100)
#RFmeanOOBerror(A, y[kGroup],
#                 g_features, epoch = 1000, nEstimators = 128,
#                               nFeatures = 5)
##%%
## Estimate whats the better scalling
#                               
#RFmeanScallingError(X[kGroup], y[kGroup], nEstimators = 128, epoch = 10)
...
if sys.argv[3] == 'Permutation':
  ...
  A, features, df, d_1, d_2, d_3, d_4, n = removeFeatures4Permutation(A, y[kGroup], nEstimators=128)
  
elif sys.argv[3] == 'No boot':
  print 'No boot - Gini method selected'
  A, features, df, d_1, d_2, d_3, d_4, n = removeFeatures3(A, y[kGroup], nEstimators=128, _type = 'No boot')
  
elif sys.argv[3] == 'Boot':
  print 'Boot - Gini method selected'
  A, features, df, d_1, d_2, d_3, d_4, n = removeFeatures3(A, y[kGroup], nEstimators=128, _type = 'Boot')  
...
# Gets dict with Deleted, Reduced, sorted Features and OOB error.
#
#d_guitar = removeFeatures(A, y[kGroup], gReducedFeatures['banjo'],
#                               itera = kFeatures-1, epoch = 1, nEstimators = 100)
#
##%%
#d_guitar2 = removeFeatures(d_guitar['X'], y[kGroup], d_guitar['Reduced'],
#                           itera = 0, epoch = 10, n_estimators = 416)
#
##%%
#
#A, g_features, dfGuitar = getArraysOfRelevantFeatures(error = d_guitar2['OOB error'],
#                                                  deleted = d_guitar2['Deleted'],
#                                                  reduced = d_guitar2['Reduced'],
#                                                  number = 20, type = 1) 
##%%
## if you decide to go ahead with an scalling. 
##A = robust_scaler.fit_transform(A)
...
#
##%%
#d_guitar3 = removeFeatures(A, y[kGroup], g_features,
#                                itera = 0, epoch = 100, n_estimators = 416) 
##%%
#
#
#A, features, dfVocal = getArraysOfRelevantFeatures(error = d_guitar3['OOB error'],
#                                                  deleted = d_guitar3['Deleted'],
#                                                  reduced = d_guitar3['Reduced'],
#                                                  number = 0, type = 1)                                 
##%%
#saveDictsinGVariables(d_guitar, d_guitar2, d_guitar3)
#
...
#startTime = datetime.now() 
#
## quantitative testing with a RF classifier, score is summaried over N epochs
#
#_Vscore = []
#epoch = 10                                        
#X_train, X_test, y_train, y_test = train_test_split(A, y[kInstrument],
#                                                    train_size=0.8,
#                                                    random_state=None)
#                                                    
#for i in range(epoch):
...
##                                                    train_size=0.8,
##                                                    random_state=None)
#    forest = RandomForestClassifier(n_estimators=416, warm_start=True,
...
#
#print 'RF Validation R2 score mean: %f \n' % (np.mean(_Vscore))      
#print 'RF Validation R2 score std: %f \n' % (np.std(_Vscore))
#print 'RF Test R2 score: %f \n' % (forest.score(X_test, y_test))    
#print '\nExecuted in: %s. \n ' % (str(datetime.now() - startTime))  
#
##%%
#
...
#startTime2 = datetime.now() 
#
## quantitative testing with a SVM classifier, score is summaried over N epochs
#
#_Vscore = []
#
#epoch = 100
...
#         
#print 'SVC Validation R2 score: %f \n' % (np.mean(_Vscore))      
#print 'SVC Validation R2 score std: %f \n' % (np.std(_Vscore))
#print 'SVC Test R2 score: %f \n' % (svc.score(X_test, y_test))    
#print '\nExecuted in: %s. \n ' % (str(datetime.now() - startTime2))  
##%%
#
##Logistic Regression
...
#
## quantitative testing with a Logistic Regression classifier, score is summaried over N epochs
#
#_Vscore = []
#
#epoch = 100                                        
...
#         
#print 'LG Validation R2 score: %f \n' % (np.mean(_Vscore))      
#print 'LG Validation R2 score std: %f \n' % (np.std(_Vscore))
#print 'LG Test R2 score: %f \n' % (clf.score(X_test, y_test))    
#print '\nExecuted in: %s. \n ' % (str(datetime.now() - startTime3)) 
##%%
#print '\nRF, SVC, and LG Executed in: %s. \n ' % (str(datetime.now() - startTime)) 
#
#
##%%
#
...
#
##%%
## First attempts with a regression algorithm.
...
#
#
#AX = dfElectricBass[dfElectricBass['stem']==0]
#AX = AX.loc[:,AX.columns[0]:AX.columns[-2]]
#Ay = dfElectricBass[dfElectricBass['stem']==1]
#Ay = Ay.loc[:,Ay.columns[0]:Ay.columns[-2]]
#
...
#_estimators = 1000
#
#regr_rf = RandomForestRegressor(n_estimators = _estimators, max_depth=_max_depth, random_state=None)
...
#
#plot(svm_pre,'k--', y_test.values,'r--')
#
